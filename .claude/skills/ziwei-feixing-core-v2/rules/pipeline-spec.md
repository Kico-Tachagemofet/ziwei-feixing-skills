...
> v1.0 来源：2026-05-20 用户 pipeline 复盘六点校准
...
> v2.2 变更：**短卡全部开局加载** — Tier 2=短卡(开局), Tier 4=deep(按需); source-lookup 收窄为 deep 决策 [2026-05-21 用户 校准: Astarion case 漏读短卡+deep导致断语偏]
...
> 
> **启用条件**: 用户 明确说 "跑 R1" / "做验前事" / "training mode"
> **禁用条件**: 默认 / "全自动跑" / "生产模式"
